...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String classAuthor = "jy_zhoudf";		// 类作者，例：ThinkGem
		...
		String templatePath = classPath.replace(separator+"WebContent"+separator+"WEB-INF"+separator+"classes",
				separator+"src"+separator+"com"+separator+"thinkgem"+separator+"jeesite"+separator+"modules");
		String javaPath = classPath.replace(separator+"WebContent"+separator+"WEB-INF"+separator+"classes", 
